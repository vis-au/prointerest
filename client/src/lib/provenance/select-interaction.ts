...
export default class Select implements ScatterplotInteraction {
  public mode: ScatterplotInteractionMode = "select";
  public x = 0;
  public y = 0;
  public std = 0;
  ...
  public getAffectedItems(): DataItem[] {
    ...
    const affectedDataItems = this.getItemsInRegion(x0, y0, x3, y3).filter((item) => {
