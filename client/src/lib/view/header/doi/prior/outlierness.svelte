  ...
  <p class="explanation" style="max-width:{width}px">
    ...
    {#if $selectedOutlierMeasure === "elliptic"}
      Apply sklearn's EllipticEnvelope metric. Check the <Link
        href="https://scikit-learn.org/stable/modules/generated/sklearn.covariance.EllipticEnvelope.html"
        >documentation</Link
      > for more details.
    {:else if $selectedOutlierMeasure === "oneclass"}
      Apply sklearn's OneClassSVM metric. Check the <Link
        href="https://scikit-learn.org/stable/modules/generated/sklearn.svm.OneClassSVM.html"
        >documentation</Link
      > for more details.
    {:else if $selectedOutlierMeasure === "forest"}
      Apply sklearn's IsolationForest metric. Check the <Link
